...
<?php
$data=["nimi" => "Alexey Maev",
    "aadress" => "Sõpruse pst, 184 Tallinn",
    "pilt" => "xp.jpg",
    "koduleht" => "https://tthk.ee"];
?>
...
<p>
    ...
    <img src="<?=$data["pilt"]?>" alt="xp">
<br>
<a href="<?=$data["koduleht"]?>" target="_blank">TTHK koduleht</a>

<h2>Ülesanne 1 massiv array funktiooniga</h2>
<?php
$array=array("Alexey Maev", "Sõpruse pst 184", "xp.jpg", "www.tthk.ee");

echo "<b>$array[0]</b>";
echo "<br>";
echo "<i>$array[1]</i>";
echo "<br>";
echo "<img src='$array[2]' alt='xp'>";
echo "<br>";
